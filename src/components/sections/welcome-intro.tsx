            ...
            <div className="grid grid-cols-2 gap-6 pt-8">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  initial="hidden"
                  animate={isInView ? "visible" : "hidden"}
                  className="group flex items-center gap-4 p-4 rounded-2xl bg-gray-50 hover:bg-primary/5 border border-gray-100 hover:border-primary/20 transition-all duration-300"
                >
                  <motion.div
                    custom={index}
                    ...
                    initial="hidden"
                    animate={isInView ? "visible" : "hidden"}
                    className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary group-hover:scale-110 transition-all duration-300"
                  >
