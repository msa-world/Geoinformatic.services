...
export default function HeroVideo() {
    ...
    return (
        <section className="relative h-screen min-h-[500px] md:min-h-[600px] overflow-hidden bg-gradient-to-b from-[#023e8a] to-[#001529]">
            ...
            <div className="relative z-10 flex h-full items-center justify-center pointer-events-none">
                <div className="container mx-auto px-4 text-center pointer-events-auto">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <motion.h1
                                className="mb-4 md:mb-6 text-3xl sm:text-4xl font-bold text-white md:text-6xl lg:text-7xl tracking-tight px-2"
                            ...
                            <motion.p
                                className="mb-6 md:mb-8 text-base sm:text-lg text-gray-200 md:text-xl max-w-3xl mx-auto leading-relaxed px-2"
                                initial={{ opacity: 0, y: 30 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                                <a
                                    href="/contact"
                                    className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#C7A24D] to-[#D97D25] text-white font-semibold rounded-full hover:shadow-lg hover:shadow-orange-500/30 transition-all hover:scale-105 text-sm sm:text-base"
                                >
                                    Get Started
                                </a>
                                <a
                                    href="/projects"
                                    className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 border-2 border-white/30 text-white font-semibold rounded-full hover:bg-white/10 transition-all text-sm sm:text-base"
                                >
                                    View Projects
                                </a>
                            </motion.div>
            ...
            <button
                onClick={prevSlide}
                className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white/10 backdrop-blur-md text-white hover:bg-white/20 transition-all border border-white/20"
            ...
            <button
                onClick={nextSlide}
                className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white/10 backdrop-blur-md text-white hover:bg-white/20 transition-all border border-white/20"
